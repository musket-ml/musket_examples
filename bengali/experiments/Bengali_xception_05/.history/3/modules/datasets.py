...
def getBengali0():
    return image_datasets.MultiOutputClassClassificationDataSet("bengali-cv19/train", "bengali-cv19/train.csv", 'image_id', ['grapheme_root', 'vowel_diacritic', 'consonant_diacritic'])
